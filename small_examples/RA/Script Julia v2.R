...
dict %>%
  bind_rows(tibble(
    model_varname = "N2O_soils", # this is free to choose but must be unique
  ...
  bind_rows(tibble(
    model_varname = "Milk",
    full_name = "Cows'milk collection and products obtained - monthly data",
    database  = "eurostat",
    variable_code = "D1110D",
    dataset_id = "apro_mk_colm",
    var_col = "dairyprod",
    freq = "m",
    geo = "AT",
    unit = "THS_T",
    ...
    nace_r2 = "B-D")) %>%
  bind_rows(tibble(
    model_varname = "Transport",
    full_name = "Road freight transport by type of operation and type of transport - (t, tkm, vehicle-km) - quarterly data",
    database  = "eurostat",
    variable_code = "TOTAL",
  ...
  #   full_name = "Commercial flights by reporting country",
  #   database  = "eurostat",
  #   variable_code = "TOTAL",
  #   dataset_id = "avia_tf_cm",
  #   var_col = "schedule",
  #   freq = "m",
  #   geo = "AT",
  #   unit = "NR",
  ...
  bind_rows(tibble(
    ...
    nace_r2 = "B-D")) %>%
  bind_rows(tibble(
    model_varname = "RB_Permits",
    full_name = "Consumption of electricity - GWh",
    database  = "eurostat",
    variable_code = "CPA_F41001",
